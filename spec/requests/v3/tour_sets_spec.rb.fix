...
RSpec.describe 'V3::TourSets', type: :request do
  ...
  context 'get tour sets as super user' do
    ...
    before { get "/#{Apartment::Tenant.current}/tour_sets", headers: { Authorization: "Bearer #{login1.oauth2_token}" } }
  ...
  context 'get tour sets as an author' do
    ...
    before { get "/#{Apartment::Tenant.current}/tour_sets", headers: { Authorization: "Bearer #{login2.oauth2_token}" } }
    # puts Role.first.title
