...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tour_tourinfo', 'position', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'TourInfo.position'
        db.alter_column('tour_tourinfo', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
