...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TourStop.metadescription'
        db.add_column('tour_tourstop', 'metadescription',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TourStop.metadescription'
        db.delete_column('tour_tourstop', 'metadescription')
