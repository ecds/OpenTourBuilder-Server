...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourStopMedia.metadata'
        db.add_column('tour_tourstopmedia', 'metadata',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TourStopMedia.metadata'
        db.delete_column('tour_tourstopmedia', 'metadata')
