...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TourStopMedia.source_link'
        db.add_column('tour_tourstopmedia', 'source_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=525, blank=True),
                      keep_default=False)

        # Adding field 'TourStopMedia.meta_data'
        db.add_column('tour_tourstopmedia', 'meta_data',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TourStopMedia.source_link'
        db.delete_column('tour_tourstopmedia', 'source_link')

        # Deleting field 'TourStopMedia.meta_data'
        db.delete_column('tour_tourstopmedia', 'meta_data')
    ...
    models = {
        ...
        'tour.tourstop': {
            ...
            'description_brief': ('tinymce.models.HTMLField', [], {'default': "''", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
