...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tour.fb_app_id'
        db.add_column('tour_tour', 'fb_app_id',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tour.fb_page_id'
        db.add_column('tour_tour', 'fb_page_id',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tour.twitter_acct'
        db.add_column('tour_tour', 'twitter_acct',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tour.fb_app_id'
        db.delete_column('tour_tour', 'fb_app_id')

        # Deleting field 'Tour.fb_page_id'
        db.delete_column('tour_tour', 'fb_page_id')

        # Deleting field 'Tour.twitter_acct'
        db.delete_column('tour_tour', 'twitter_acct')
    ...
    models = {
        'tour.tour': {
            ...
            'fb_app_id': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'fb_page_id': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
