...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourStop.mp4'
        db.add_column('tour_tourstop', 'mp4',
    ...
    def backwards(self, orm):
        ...
        db.create_table('tour_tourstopvideo', (
            ...
            ('ogg', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('tour', ['TourStopVideo'])

        # Deleting field 'TourStop.mp4'
        db.delete_column('tour_tourstop', 'mp4')
