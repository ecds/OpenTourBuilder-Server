...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tour_toursplashimage', (
            ...
            ('spalshimage', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True)),
        ))
    ...
    models = {
        ...
        'tour.toursplashimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'spalshimage': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
