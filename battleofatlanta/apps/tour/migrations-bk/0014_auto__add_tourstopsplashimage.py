...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TourStopSplashImage'
        db.create_table('tour_tourstopsplashimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tour_stop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tour.TourStop'])),
            ('file', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
        ))
        db.send_create_signal('tour', ['TourStopSplashImage'])


    def backwards(self, orm):
        # Deleting model 'TourStopSplashImage'
        db.delete_table('tour_tourstopsplashimage')
    ...
    models = {
        ...
        'tour.tourstopsplashimage': {
            'Meta': {'object_name': 'TourStopSplashImage'},
            'file': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tour_stop': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tour.TourStop']"})
        }
    }
