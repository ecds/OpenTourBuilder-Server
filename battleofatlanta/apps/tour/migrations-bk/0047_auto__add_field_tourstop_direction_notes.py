...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TourStop.direction_notes'
        db.add_column('tour_tourstop', 'direction_notes',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TourStop.direction_notes'
        db.delete_column('tour_tourstop', 'direction_notes')
    ...
    models = {
        ...
        'tour.tourstop': {
            ...
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '22'}),
