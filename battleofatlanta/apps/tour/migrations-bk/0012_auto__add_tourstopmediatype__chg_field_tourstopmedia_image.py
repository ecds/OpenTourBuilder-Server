...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tour_tourstopmedia', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TourStopMedia.image'
        db.alter_column('tour_tourstopmedia', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
