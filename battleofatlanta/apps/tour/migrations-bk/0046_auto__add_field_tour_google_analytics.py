...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tour.google_analytics'
        db.add_column('tour_tour', 'google_analytics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tour.google_analytics'
        db.delete_column('tour_tour', 'google_analytics')
