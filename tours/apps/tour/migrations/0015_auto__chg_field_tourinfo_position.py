...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TourInfo.position'
        db.alter_column(u'tour_tourinfo', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TourInfo.position'
        db.alter_column(u'tour_tourinfo', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
