...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DirectionsMode.default'
        db.delete_column('tour_directionsmode', 'default')


    def backwards(self, orm):
        # Adding field 'DirectionsMode.default'
        db.add_column('tour_directionsmode', 'default',
    ...
    models = {
        ...
        'tour.tour': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['tour.DirectionsMode']"}),
