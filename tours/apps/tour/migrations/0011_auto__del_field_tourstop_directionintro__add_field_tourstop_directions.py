...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourStop.directions_intro'
        db.add_column(u'tour_tourstop', 'directions_intro',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TourStop.directions_intro'
        db.delete_column(u'tour_tourstop', 'directions_intro')
