    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_mode', models.CharField(default=b'', max_length=50, blank=True, choices=[('TRANSIT', 'TRANSIT'), ('BICYCLING', 'BICYCLING'), ('WALKING', 'WALKING')])),
                ...
                ('modes', models.ManyToManyField(related_name='modes', to='tour.DirectionsMode')),
            ],
            options={
                'verbose_name': 'Tour',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ForeignKey(related_name='info_ids', to='tour.Tour')),
            ],
            options={
                'ordering': ['position'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(null=True, verbose_name=b'Position', blank=True)),
                ('tour', models.ForeignKey(related_name='stop_ids', to='tour.Tour')),
            ],
            options={
                'ordering': ['position'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(null=True, verbose_name=b'Position', blank=True)),
                ('tour_stop', models.ForeignKey(related_name='images', to='tour.TourStop')),
            ],
            options={
                'ordering': ['position'],
