...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DirectionsMode.active'
        db.add_column(u'tour_directionsmode', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DirectionsMode.active'
        db.delete_column(u'tour_directionsmode', 'active')
