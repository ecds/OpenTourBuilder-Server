...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TourStop.video_poster'
        db.add_column(u'tour_tourstop', 'video_poster',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TourStop.video_poster'
        db.delete_column(u'tour_tourstop', 'video_poster')
