...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TourStopMedia.image'
        db.alter_column(u'tour_tourstopmedia', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'TourStopMedia.inline'
        db.alter_column(u'tour_tourstopmedia', 'inline', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Adding field 'TourStop.directionintro'
        db.add_column(u'tour_tourstop', 'directionintro',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TourStopMedia.image'
        db.alter_column(u'tour_tourstopmedia', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'TourStopMedia.inline'
        db.alter_column(u'tour_tourstopmedia', 'inline', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        # Deleting field 'TourStop.directionintro'
        db.delete_column(u'tour_tourstop', 'directionintro')
    ...
    models = {
        ...
        u'tour.tourstop': {
            ...
            'directionintro': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
